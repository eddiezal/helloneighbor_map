// src/components/ListView/EnhancedProducerListItem.tsx
...
interface EnhancedProducerListItemProps {
  producer: Producer;
}

const EnhancedProducerListItem: React.FC<EnhancedProducerListItemProps> = ({ producer }) => {
      ...
      >
        <div className="p-4 pt-0 border-t mt-2">
          ...
          <div className="flex space-x-2 mt-4">
            <button className="flex-1 bg-primary text-white py-2.5 px-4 rounded-xl text-sm font-medium transform transition-transform hover:translate-y-[-2px] hover:shadow-md active:translate-y-0">
              View Profile
            </button>
...
export default EnhancedProducerListItem;